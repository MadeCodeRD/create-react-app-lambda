...
import { filterSurveyEmployee } from "../../../../redux/slices/HappyQ_Company/Company_Survey";
...
const makeEmployeeObject = ({
  ...
  return {
    ...
    date: !isEditing
      ...
      : employeeToUpdate.date,
    email: values.email,
    role: values.role,
    status: !isEditing ? STATUS.ACTIVE : employeeToUpdate.status,
    company: company.id,
...
function EmployeeForm() {
  ...
  const handleSubmit = async (
    ...
    try {
      await timeOut(1500);
      const isEditing = Object.keys(currentEmployee).length !== 0;
      if (!isEditing) {
        ...
        dispatch(addEmployee([newEmployee, ...employeeData]));
      } else {
              ...
              <form onSubmit={handleSubmit}>
                ...
                >
                  ...
                  >
                    ...
                    <MenuItem value={"Jefe_Sucursal"}>Jefe Sucursal</MenuItem>
                  </Select>
                  {touched.role && (
