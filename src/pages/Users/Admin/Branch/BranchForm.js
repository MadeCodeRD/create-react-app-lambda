...
import { filterCompanyBranch as filterTicketBranchName } from "../../../../redux/slices/HappyQ_Admin/Admin_Tickets";
import { filterCompanyBranch as filterBookingBranchName } from "../../../../redux/slices/HappyQ_Admin/Admin_Booking";
import { filterSurveyBranch } from "../../../../redux/slices/HappyQ_Admin/Admin_Survey";
import {
  Alert as MuiAlert,
  Box,
  Button as MuiButton,
...
const makeBranchObject = ({ values, branchToUpdate }) => {
  return {
    ...
    date: branchToUpdate.date,
    email: values.email,
    role: branchToUpdate.role,
    status: branchToUpdate.status,
    company: branchToUpdate.company,
...
function BranchForm() {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      branches = branches.filter((employee) => values.id !== employee.id);
